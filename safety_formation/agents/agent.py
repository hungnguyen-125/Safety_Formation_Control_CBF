...
class Agent:
    ...
    def __init__(self, agent_id, x0, f_target, alpha=10, beta=10, dynamics=None):
        ...
        alpha : float
            Maximum acceleration/braking parameter used by CBF constraints.
        beta : float
            Maximum velocity parameter used by dynamic CBF topology.
        dynamics : BaseDynamics, optional
            Dynamics model used to update the agent state.
        """
        self.id = agent_id
